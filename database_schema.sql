...
-- Run these queries in your MySQL database to create the required tables
...
INSERT INTO email_templates (user_id, name, subject, content, template_type, is_default) VALUES
(1, 'Welcome Email', 'Welcome to MailSkrap!', 
'<h1>Welcome to MailSkrap!</h1><p>Thank you for joining us. We are excited to help you with your email marketing journey.</p>', 
'marketing', TRUE),

(1, 'Newsletter Template', 'Monthly Newsletter', 
'<h2>Monthly Newsletter</h2><p>Here are the latest updates and news from our team.</p>', 
'newsletter', TRUE),

(1, 'Promotional Email', 'Special Offer Just for You!', 
'<h1>Special Offer</h1><p>Do not miss out on this exclusive deal. Limited time only!</p>', 
'marketing', TRUE),

(1, 'Follow-up Email', 'Did you see our previous email?', 
'<h2>Following up on our previous email</h2><p>Hi {FirstName},</p><p>I wanted to follow up on the email I sent you earlier. I hope you found it helpful!</p><p>If you have any questions or would like to learn more, please don\'t hesitate to reach out.</p><p>Best regards,<br>The MailSkrap Team</p>', 
'followup', TRUE);
